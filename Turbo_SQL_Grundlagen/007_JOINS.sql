...
-- idealerweise sollte aber auch dabeistehen, aus welcher Tabelle die Information kommt, wenn der Spaltenname (derzeit) eindeutig ist; Tabellen könnten sich verändern!
...
-- auch hier wieder überall angeben, aus welcher Tabelle:
SELECT	  o.OrderID
		, o.CustomerID
		, c.CompanyName
		, o.ShippedDate
...
-- mit String-Funktion kombiniert
SELECT	  o.OrderID
		, o.EmployeeID
		, CONCAT(e.FirstName, ' ', e.LastName) AS Mitarbeiter
FROM Orders o INNER JOIN Employees e ON o.EmployeeID = e.EmployeeID
...
-- JOINS von mehr als zwei Tabellen:
SELECT	  o.OrderID
		, c.CustomerID
		, c.CompanyName
		, o.ShippedDate
